...
namespace _4phn
{
    class Const
    {
        ...
        public struct SQL
        {
            ...
            public readonly static string SELECT_HISTORY = "SELECT calldate, clid, src, dst, duration, disposition, src as srcimage FROM cdr WHERE (src= '{0}' or dst= '{0}' or realdst= '{0}' or dstchannel like '%{0}%') and dst <> '*76' ORDER BY id DESC LIMIT 100;";
